...
// TOAST MESSAGE
// ============================================
function showToast(message = '🚀 Conecta Xexéu - Em breve') {
...
function setActiveTab(activeBtn) {
    navButtons.forEach(btn => {
        ...
        if (btn === activeBtn) {
            ...
            if (icon && btn.querySelector('i.fa-home')) icon.style.color = '#2563eb';
        } else {
            btn.classList.remove('text-blue-600');
            btn.classList.add('text-gray-400');
            if (icon && btn.querySelector('i.fa-home')) icon.style.color = '#6b7280';
        }
    });
}
...
// Define aba "Início" como ativa por padrão
